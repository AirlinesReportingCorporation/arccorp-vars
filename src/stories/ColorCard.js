  ...
  return (
    <div className={"sb-color-card-outer " + props.class}>
      ...
      <div className="d-flex">
        <CopyToClipboard text={props.hex}>
          <a
            onClick={() => alert("Copied hex value " + props.hex)}
            className="ctaBtn"
            style={{
        ...
        <CopyToClipboard text={props.class}>
          <a
          onClick={() => alert("Copied class: " + props.class)}
            className={
              props.name == "Teal"
                ? "ctaBtn sbBtn-secondary"
                : "ctaBtn ctaBtn--main-outline"
            }
