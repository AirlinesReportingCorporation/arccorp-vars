...
<Row>
  <Col md={2}>0.3.5 <em>(Latest Version)</em></Col>
  <Col>
    <span style={{color: "orange"}}>ARC Accordions</span> <br/>
    Removed this.props fixed from class and id props.

    <span style={{color: "orange"}}>Updated release notes with additional build instrucions</span> <br/>
    Added new instructions to build notes to include adding exports in index.jsx before building.
  </Col>
</Row>

<Row>
  <Col md={2}>0.3.1 - 0.3.4</Col>
  <Col>
    <span style={{color: "orange"}}>Build Debugging for adding new hook components</span> <br/>
    These versions were used to test new publishing versions for hooks and matching react versions with arccorp.
  </Col>
</Row>

<Row>
  <Col md={2}>0.3.0 <em></em></Col>
  <Col>
